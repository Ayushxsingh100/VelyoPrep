...
import { Search, X, ArrowUpRight, Plus, Trash2, Link } from "lucide-react";

// Standard brand colors to make each card beautiful, premium, and identifiable
...
// SVG logos configured to render cleanly inside our brand icon container
...
export const JobsScreen: React.FC<JobsScreenProps> = (props) => {
  ...
  return (
    ...
    >
      {/* 1. Pure minimalist Apple style Header */}
      <div className="pt-4 flex items-center justify-between">
        ...
        >
          {/* Subtle backplate shine animation when not adding */}
          {!isAdding && (
            <motion.span
              animate={{ x: ["-100%", "200%"] }}
      ...
      {/* Collapsible pristine sliding Add Website Form */}
      <AnimatePresence>
        {isAdding && (
          <motion.div
      ...
      {/* 2. Apple Search Bar - Clean, high contrast, visually attractive search container */}
      <motion.div
      ...
      {/* 3. Main Directory - Extremely attractive grid card design, optimized for high contrast dark theme */}
          ...
          {filteredWebsites.length === 0 ? (
            ...
            <AnimatePresence mode="popLayout">
              {filteredWebsites.map((portal) => {
                ...
                // Deterministic beautiful high contrast gradients & themes for custom websites
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between min-w-0">
                      <div className="flex items-center space-x-4 min-w-0">
                        ...
                        {/* Text Block with pristine high contrast WCAG AA compliant text colors */}
                      ...
                      {/* Pure interactive action badge / link circle arrow - styled as perfect circles with outstanding contrast and micro-interactivity */}
